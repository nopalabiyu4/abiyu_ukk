        ...
        <div class="row" style="padding: 10px;">
          <?php foreach ($query as $item): ?>
            ...
            <div class="col-md-3 d-flex justify-content-center mb-3">
              <img src="../../imgDB/<?= $item["cover"]; ?>" width="190px"
                style="width: 300px; aspect-ratio: 8/12; border-radius: 10px;">
            </div>
            <!-- description -->
          ...
          <div class="card-body">
            <form action="" method="post">
              ...
              <div class="input-group mb-3 mt-3">
                ...
                <input type="date" name="tgl_kembali" id="tgl_kembali" class="form-control" placeholder="tgl_kembali"
                  aria-label="tgl_kembali" required>
              </div>
